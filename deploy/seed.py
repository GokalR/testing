"""Seed the education database with sample courses, videos, and learning content."""

import asyncio
import sys
import os

# Add deploy dir to path so app package is importable
sys.path.insert(0, os.path.dirname(__file__))

from app.db_async import BaseAsync, engine_async, async_session
from app.models_education import Course, LearningContent, Video
