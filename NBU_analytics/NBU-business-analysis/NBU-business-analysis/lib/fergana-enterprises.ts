 ...
 *
 * Sources:
 *   Yodgorlik:          britannica.com, advantour.com, tripadvisor.com
 *   Margilan Silk:      central-asia.guide, advantour.com
 *   Global Textile:     gov.uz/en/miit/news/view/80910
 *   Innovative Apparel: trend.az, kursiv.media (Aug 2025)
 *   Handicraft Center:  uzbekistan.travel, central-asia.guide
 */

export interface KeyEnterprise {
  name: string;
  district: string;
  type: "production" | "craft" | "fdi";
  workers: number;
  detail: string;
  source: string;
}
